...
func Test_validateWebhook(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "legacy o365 connector", args: args{u: "https://outlook.office.com/webhook/1e21eb6d-60f4-432f-9428-82cf86ec55a3@b12d4011-2ea0-4377-a99b-35c565546afd/IncomingWebhook/091d20cd2a594db0b2d7ed2937d7bd6d/91f7b1cc-96d0-4612-bedd-8b820c869464"}, wantErr: false},
...
func Test_extractWebhookFromRequest(t *testing.T) {
	o365ConnectorWebhook := "https://outlook.office.com/webhook/1e21eb6d-60f4-432f-9428-82cf86ec55a3@b12d4011-2ea0-4377-a99b-35c565546afd/IncomingWebhook/091d20cd2a594db0b2d7ed2937d7bd6d/91f7b1cc-96d0-4612-bedd-8b820c869464"
	...
	tests := []struct {
		...
		{
			name:          "legacy o365connector webhook",
			request:       newDummyRequest(fmt.Sprintf("/_dynamicwebhook/%s", o365ConnectorWebhook), ""),
			webhookResult: fmt.Sprintf("https://%s", o365ConnectorWebhook),
			wantErr:       false,
		},
		{
